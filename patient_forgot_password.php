            ...
            if ($email) {
                ...
                if ($stmt) {
                    ...
                    try {
                        ...
                        $mail->Body = "A request was received to reset the password for your Therapeace account.<br><br>Click the link below to reset your password:<br><a href='" . $resetLink . "'>Reset Password</a>";
