    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            if ($status == 1) {
                ...
                $action_link = "<a href='javascript:void(0);' onclick='displayGuestChecklist(" . (int)$row['GuestID'] . ")' style='color: #2D3748; text-decoration: none;'>Assess</a>"; 
            } elseif  ($status == 2) {   
...
<script src="therapist-dashboard.js"></script>
